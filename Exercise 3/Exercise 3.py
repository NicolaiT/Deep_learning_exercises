...
# Without any dropouts, the validation loss tend to jump up to 0.33. 
# graph_dropout.png is generated by the current code.
# graph_input_dropout_80.png only has dropout at the input.
# graph_no_dropouts.png has no dropouts.
# Another way to stop overfitting is to early stopping. (not implemented)